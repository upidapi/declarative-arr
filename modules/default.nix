  ...
  mkArrConfig = {
    ...
    init-script = pkgs.writeShellApplication {
      ...
      text = let
        ...
        dataDir = config.services.${serviceName}.dataDir;
        # bash
      in ''
        # TODO: test this
    ...
    options.services.${serviceName} = {
      ...
      guiSettings = mkOption {
        description = ''
          ...
          the json body of the request. Unless mentioned otherwise.Refer to
          what the gui sends for what thease should be.
          ...
          Some fields should insted be filepaths, thease will be replaced by
          their files content during runtime.
        '';
            ...
            lib.getAttrs (
              ...
              host = mkOption {
                ...
                description = ''
                  ...
                  .password is replaced by its file content
                '';
                default = {};
              };
              ...
              downloadClients = mkOption {
                type = types.attrs;
                description = ''
                  The attr "fields" are mapped into the key value pairs that
                  the api expects.

                  <name>.fields.password will be replaced by its file content.
                '';
                default = {};
                example = {
                  "qBittorrent" = {
